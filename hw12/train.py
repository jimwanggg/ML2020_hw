...
for epoch in range(1000):
    ...
    if (epoch + 1) % 100 == 0:
        torch.save(feature_extractor.state_dict(), f'2_extractor_model_{epoch+1:03d}.bin')
        torch.save(label_predictor.state_dict(), f'2_predictor_model_{epoch+1:03d}.bin')
        torch.save(domain_classifier.state_dict(), f'2_domain_model_{epoch+1:03d}.bin')
